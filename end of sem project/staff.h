...
void newStaffRegistration()
{
    ...
    outfile<<s1.id<<" "<<s1.fName<<" "<<s1.lName<<" "<<s1.qualification<<" "<<endl;
    cout<<"\n**Successfully Added**\n";
    outfile.close();
    return;
}
void updateStaffInform()
{
    ...
    while(std::getline(infile, line))
    {
        ...
        if(flag==1)
        {
            ...
            cout<<"Qualification:";
            cin>>s1.qualification;
            tempfile<<sId<<" "<<s1.fName<<" "<<s1.lName<<" "<<s1.qualification<<" "<<endl;
...
cout<<endl<<"\t\t\t\t !** STAFF LIST **!\t\t\n\n\n";
    cout<<setw(15)<<"S.ID"<<setw(15)<<"F.NAME:"<<setw(15)<<"L.NAME"<<setw(15)<<"QUALIFICATION"<<setw(15)<<endl<<endl;
    string line;
